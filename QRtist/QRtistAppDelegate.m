...
@implementation QRtistAppDelegate
@synthesize window;
...
- (void)applicationDidEnterBackground:(UIApplication *)application
{
    ...
    /* Barcodes are now written to disk as they are created. */
    // [[QRCodeStorageCenter sharedStorageCenter] writeBarcodesToDisk];
}

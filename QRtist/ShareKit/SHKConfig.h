...
#define SHKMyAppName			@"QRtist"
#define SHKMyAppURL				@"http://omegahern.com/qrtist"
...
#define SHKFacebookKey				@"e349b5d71b8d1862fe795d5ed476e7b2"
#define SHKFacebookSecret			@"5e31a671203e00480ad3486f7f36dfb4"
 ...
 */
#define SHKTwitterConsumerKey		@"ln2PNOaHrKLACw7jtNaxA"
#define SHKTwitterSecret			@"zV3ZqjRer1gp5YFdMQgoSUhIZCeSqBz2XmLom76XX6g"
#define SHKTwitterCallbackUrl		@"http://omegahern.com/qrtist/callback" // You need to set this if using OAuth, see note above (xAuth users can skip it)
